<template>
    <div id="nav-board" class="group flex items-center justify-between">
                <div id="board" @click="getBoard(board.id)" v-if="!isEdit"  class="flex items-center cursor-pointer text-gray-500 text-base">
...
<script setup>
    ...
    function getBoard(id){
        ...
        store.dispatch('selectedBaord', id);
